				...
				<div>
					...
					<div className="flex flex-col items-center justify-center p-6 gap-2 rounded-xl border border-gray-300  backdrop-blur-2xl dark:border-neutral-800  lg:rounded-xl lg:border bg-transparent">
						...
						<p className="text-center text-gray-500 dark:text-gray-400">
							I am 32 years old, Inspired Full Stack Developer from the United
							Kingdom, I started coding in 2015 my first project was a Discord
							Bot Built with Discord.JS I am a very friendly person and I love
