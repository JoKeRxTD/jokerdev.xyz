      ...
      <Link href={link} passHref>
        <animated.div
          ...
          className={classNames(
            ...
            "shadow-white shadow-none hover:shadow-lg mb-1 row-start-3 flex flex-row items-center bg-opacity-50 bg-slate-500/20 dark:bg-slate-800/5 rounded-md p-3 border border-zinc-800/50 cursor-pointer transition-colors duration-150"
          )}
        >
          {icon}
